...
5. **Project invariants — respect these:**
   ...
   - Zendesk indexing keeps **one representation per ticket**: re-indexing
     ...
     `VOYAGE_DIM` in `src/zendesk/embeddings.js`.
